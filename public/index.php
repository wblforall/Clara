...
$pageFiles = [
    ...
    'transaction_cancel'          => 'transactions.php',
    ...
    'skp_reject'                  => 'skp.php',
    'skp_print'                   => 'skp.php',
    'skp_sign_upload'             => 'skp.php',
    'contract_requests'           => 'contract_request.php',
    ...
    'stock_reports'               => 'stock_report.php',
    'stock_report_form'           => 'stock_report.php',
    'stock_report_save'           => 'stock_report.php',
    'stock_report_delete'         => 'stock_report.php',
    'stock_sheet'                 => 'stock_report.php',
    'stock_sheet_api'             => 'stock_report.php',
    'm_home'                      => 'mobile.php',
...
match ($route) {
    ...
    'offer_sign_upload'           => offer_sign_upload($pdo),
    ...
    'transaction_cancel'          => transaction_cancel($pdo),
    ...
    'stock_reports'               => stock_reports_page($pdo),
    'stock_report_form'           => stock_report_form($pdo),
    'stock_report_save'           => stock_report_save($pdo),
    'stock_report_delete'         => stock_report_delete($pdo),
    'stock_sheet'                 => stock_sheet_page($pdo),
    'stock_sheet_api'             => stock_sheet_api($pdo),
