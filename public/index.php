...
$masterConfig = [
    ...
    'cl' => [
        ...
        'fields'  => [
            ...
            'area_sqm' => 'Luas m2', 'rate' => 'Rate Harian/m2', 'projection_monthly' => 'Potensi Bulanan', 'status' => 'Status',
        ],
        'order'   => "CASE floor WHEN 'LG' THEN 1 WHEN 'GF' THEN 2 WHEN 'UG' THEN 3 WHEN 'FF' THEN 4 WHEN 'SF' THEN 5 ELSE 6 END, code",
    ],
    'gudang' => [
        'title'   => 'Master Gudang',
        'table'   => 'master_gudang',
